...
const CHARACTER_NAME_ALIASES = {
  ...
  spidey: ['spider-man', 'peter parker'],
  superman: ['clark kent'],
  'clark kent': ['superman', 'clark kent'],
  batman: ['bruce wayne'],
  'bruce wayne': ['batman', 'bruce wayne'],
  bats: ['batman', 'bruce wayne'],
  cap: ['captain america', 'steve rogers'],
  cr7: ['cristiano ronaldo'],
  mando: ['din djarin', 'the mandalorian'],
  captainamerica: ['captain america', 'steve rogers'],
  wonderwoman: ['wonder woman', 'diana prince'],
  aquaman: ['aquaman', 'arthur curry'],
  'arthur curry': ['aquaman', 'arthur curry'],
  cyborg: ['cyborg', 'victor stone'],
  'victor stone': ['cyborg', 'victor stone'],
  greenlantern: ['green lantern', 'hal jordan'],
  flash: ['the flash', 'barry allen'],
  captainmarvel: ['captain marvel', 'carol danvers'],
  scarletwitch: ['scarlet witch', 'wanda maximoff'],
  scarletwytch: ['scarlet witch', 'wanda maximoff'],
  blackwidow: ['black widow', 'natasha romanoff'],
  bugs: ['bugs bunny'],
  ...
  drstrange: ['doctor strange', 'dr strange', 'stephen strange'],
  doctorstrange: ['doctor strange', 'dr strange', 'stephen strange'],
  raventeentitans: ['raven dc', 'raven teen titans', 'raven'],
  'raven teen titans': ['raven dc', 'raven'],
  starfire: ['starfire', 'koriandr', 'koriandr'],
  atomeve: ['atom eve', 'samantha eve wilkins', 'samantha eve'],
  frieren: ['frieren', "frieren beyond journey's end"],
  aang: ['aang', 'avatar aang'],
  'mob physco': ['mob psycho', 'shigeo kageyama'],
  'mob psycho': ['mob psycho 100', 'shigeo kageyama'],
  mobmobphysco: ['mob psycho 100', 'shigeo kageyama'],
  davidblaine: ['david blaine'],
  magician: ['illusionist', 'stage magician'],
  loid: ['loid forger', 'twilight'],
  loidforger: ['loid forger', 'twilight', 'spy x family'],
  drwatson: ['dr watson', 'john watson', 'doctor watson'],
  'dr watson': ['dr watson', 'john watson', 'doctor watson'],
  aceventura: ['ace ventura'],
  detectiveconan: ['detective conan', 'conan edogawa', 'case closed'],
  detectivepikachu: ['detective pikachu', 'pikachu detective'],
  perrytheplatypus: ['perry the platypus', 'agent p'],
  monkeyddragon: ['monkey d dragon', 'monkey d. dragon', 'one piece'],
  monkeyddragononepiece: ['monkey d dragon', 'monkey d. dragon', 'one piece'],
  posedion: ['poseidon'],
  'megan trainer': ['meghan trainor'],
  scooby: ['scooby-doo', 'scooby doo'],
  mjolnir: ['mjolnir', 'mjölnir'],
  'elder wand': ['elder wand'],
  omnitrix: ['omnitrix'],
  pokeball: ['poke ball', 'poké ball'],
  'momo (avatar)': ['momo (avatar: the last airbender)', 'momo (avatar)'],
  'l (death note)': ['l (death note)', 'l'],
  ben10: ['ben 10', 'ben tennyson'],
  masseffect: ['mass effect', 'mass effect franchise'],
  starwars: ['star wars', 'star wars franchise'],
  indianajones: ['indiana jones'],
  muhammadali: ['muhammad ali'],
  muhhamadali: ['muhammad ali'],
  rocky: ['rocky balboa', 'rocky'],
  rockybalboa: ['rocky balboa'],
  sukuna: ['ryomen sukuna', 'sukuna'],
  jakethedog: ['jake the dog', 'adventure time'],
  jakedog: ['jake the dog', 'adventure time'],
  danawhite: ['dana white', 'ufc'],
  joerogan: ['joe rogan', 'ufc commentator'],
  lebronjames: ['lebron james'],
  lebron: ['lebron james'],
  finnthehuman: ['finn the human', 'adventure time'],
  brucelee: ['bruce lee'],
  kinghenry: ['henry viii of england', 'king henry viii'],
  teddyroosevelt: ['theodore roosevelt', 'teddy roosevelt'],
  theodoreroosevelt: ['theodore roosevelt', 'teddy roosevelt'],
  jfk: ['john f. kennedy', 'john fitzgerald kennedy'],
  johnfkennedy: ['john f. kennedy', 'john fitzgerald kennedy'],
